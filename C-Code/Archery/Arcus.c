/*
    ...
    Okay I was never a history person... ( That was the wiki intro on Archery ) That being said what this piece of standalone code does is 
        Uses the graphics package of C ( Source - http://www.programmingsimplified.com/c/graphics.h )
        I technically draw stuff (Sorry I really suck at explaining stuff) that is needed to, well play the game.
        What I have done (that could be more usefull) is that there is an help page once the code is executed, so help yourself.
*/
...
/*
	The set of functions defined cause I wanted the main() on top
*/
...
void main(){
	/*
		Initializing stuff at the start of the game
		They are pretty much self explanatory... 
		Or maybe I lost my sanity somewhere half way through
	*/
	...
	while (!finish){
		...
		/*
			Just a bunch of conditions to check on the Balloon Arrow and other game ending conditions
		*/
